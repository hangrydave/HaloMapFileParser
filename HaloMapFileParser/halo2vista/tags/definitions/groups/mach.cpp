...
{
	tag_collection* mach_group = new tag_collection(
	"mach",
	{
		...
		short_tag("Type"),
		short_tag("Flags"),
		long_tag("Door Open Time"),
		long_tag("Door Occlusion Bounds min"),
		long_tag("Door Occlusion Bounds max"),
		short_tag("Collision Response"),
		short_tag("Elevator Node"),
