...
{
	tag_collection* _sce_group = new tag_collection(
	"_sce",
	{
		...
		block_tag("Objects",
		{
			...
			long_tag("Height"),
			long_tag("Override Distance Bounds min"),
			long_tag("Override Distance Bounds max"),
			undefined_tag("Override Cone Angle Bounds min", 9999),
			undefined_tag("Override Cone Angle Bounds max", 9999),
