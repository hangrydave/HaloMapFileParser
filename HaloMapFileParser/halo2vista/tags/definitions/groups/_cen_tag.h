...
namespace _cen_tag
{
	...
	struct group
	{
		...
		long next_scenery_object_id_salt;
		s_tag_block palette2_block;
		s_tag_block objects2_block;
		long next_block_object_id_salt;
