...
void utilities::print_hex_dec(std::string label, unsigned long data)
{
    std::stringstream ss;
...
void utilities::print_thing(std::string label, unsigned long data)
{
    printf("%-40s%-21s\n", label.c_str(), std::to_string(data).c_str());
}

void utilities::print_thing(std::string label, short data)
{
    printf("%-40s%-21s\n", label.c_str(), std::to_string(data).c_str());
}

void utilities::print_thing(std::string label, bool data)
{
    printf("%-40s%-21s\n", label.c_str(), std::to_string(data).c_str());
}
